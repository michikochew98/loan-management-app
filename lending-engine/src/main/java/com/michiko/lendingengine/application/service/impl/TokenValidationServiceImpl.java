package com.michiko.lendingengine.application.service.impl;
...
public class TokenValidationServiceImpl implements TokenValidationService{
	...
	@Autowired
	public TokenValidationServiceImpl(final UserRepository userRepository, @Value("${security.baseurl}") String securityContextBaseUrl) {
